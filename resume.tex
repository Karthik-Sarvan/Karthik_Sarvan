...
% PROFESSIONAL BRIEF
% ==========================================
\cvsection{Professional Brief}{Collaborative \textbar{} Driven \textbar{} Adaptable}

\noindent \fontsize{20} \textit
"Beyond technical execution, I am a highly collaborative team player who thrives in environments where engineers actively share knowledge and tackle complex problems together. I bring a genuine passion for continuous learning, an adaptable mindset, and a strong drive to grow alongside a forward-thinking company to deliver robust, impactful hardware solutions."}
